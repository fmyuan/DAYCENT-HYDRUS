...
c                       All Rights Reserved
      ...
      subroutine dshoot(bgwfunc, tfrac, dstart, dend)
...
c ..... Let senescence occur once a month, at end of month.  -mdh 2/4/98
        if ((dosene .and. (frtcindx .lt. 3) .and.
     &      (seneday .ge. dstart .and. seneday .le. dend)) .or.
     &      (senmschd .and. (frtcindx .eq. 3) .and.
     &      (seneday .le. dend) .and. (thermunits .ge. ddbase)) .or.
     &      (senmschd .and. accumdd .and. (frtcindx .eq. 3) .and.
     &      (plntkill))) then
          index = 2
          dthppt = 1.0

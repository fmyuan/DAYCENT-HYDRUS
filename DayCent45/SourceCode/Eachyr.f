...
c ... Add code to reset the frstday or plntday values as necessary to allow a
c ... grass/crop that grows over the December/January boundary using the
c ... growing degree day implementation that has not yet started to grow to
c ... start growth once the growth criterion have been met, cak - 06/19/03

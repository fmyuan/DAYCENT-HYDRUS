...
c ... Argument declarations
     ...
     &          som1e(2,MAXIEL), som2ci(ISOS), som2e(MAXIEL)
      real*8    newminrl
...
c ...   som2ci(iso)     - C by isotope in soil organic matter with
c ...                     intermediate turnover rate (g/m2)
c ...                     (iso=1,2) (1) unlabeled; (2) labeled
c ...   som2e(iel)      - N, P, and S in soil organic matter with
c ...                     intermediate turnover rate (g/m2)
c ...                     (iel=1,3) (1)=N     (2)=P     (3)=S
...
c ..... Partition and schedule C flows by isotope
     ...
     &              cstatv(llyr,UNLABL),som2ci(UNLABL),
     &              cstatv(llyr,LABELD),som2ci(LABELD),
     &              1.0,accum)

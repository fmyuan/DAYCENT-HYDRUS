...
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------
     &          storage(MAXIEL), uptake(5,MAXIEL)
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------
...
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------
!     &                 storage(iel)
     &                 storage(iel)+feramt(iel)*ferfol/(1.-ferfol)                  ! adding foliage absorption
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------
45    continue
...
c ... automatic fertilizer
      do 200 iel = 1, nelem
!        ustorg(iel) = min(storage(iel), eprodl(iel))    ! Yuan: this will make eprodl>=ustorg, why?
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------
        ustorg(iel) = storage(iel)+feramt(iel)*ferfol/(1.0-ferfol)    ! adding foliage absorption
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------
...
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------
          uptake(ESTOR,iel)=eprodl(iel)-feramt(iel)*ferfol/(1.0-ferfol)
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------
...
c          uptake(ESOIL,iel) = eprodf(iel) - storage(iel)
...
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------
        uptake(EFOLI,iel) = feramt(iel)/(1.-ferfol)*ferfol       !adding foliage absorption: feramt excluded ferfol
C -----------fmyuan: modification for BIOCOMPLEXITY Project ------------

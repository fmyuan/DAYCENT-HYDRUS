* Source file WATFLOW.FOR ||||||||||||||||||||||||||||||||||||||||||||||
     ...
     &                   rTop,rBot,t,dt,x,Sink,P,R,S,FreeD,
     &                   qGWLF,Aqh,Bqh,GWL0L,hTop,hBot,
     ...
     &                   POptm,P2H,P2L,P3,r2H,r2L,Beta,vRoot,rRoot)
      ...
      logical ConvgF,ItCrit,FreeD,qGWLF,TopInf,WLayer,SinkF
...
*     Generate terms of matrix equation and solve by Gauss elimination
     ...
     &            R,S,PB,RB,SB,PT,RT,ST,FreeD,qGWLF,Aqh,Bqh,
